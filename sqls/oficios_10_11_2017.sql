...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 11-11-2017 a las 01:07:48
...
(1, 'CSEIIO/DP/098/2017', '2017-09-04', '16:51:31', 'Solicitud de Material para Comisión', 'Interno', 'Memorandúm', 'LIC. JACOBO SÁNCHEZ LÓPEZ', 'DIRECTOR DE PLANEACIÓN', 'CSEIIO', 2, '2017-09-06', 'oficioaplaneacionpdf.pdf', 'Fuera de Tiempo', 'Alta', 'Turnar a bienes y servicios', 1, 1, 1, 1),
...
(4, 'CSEIIO/DA/264/2017', '2017-10-03', '11:40:18', 'Solicitud de apoyo', 'Interno', 'Memorandúm', 'C.P MARIO ANTONIO REYES BAUTISTA', 'DIRECTOR ADMINISTRATIVO', 'CSEIIO', 4, '2017-10-06', 'oficioexamplepdf.pdf', 'Contestado', 'Alta', 'Ninguna', 1, 0, 1, 1),
(5, 'CSEIIO/DA/1234/2017', '2017-10-03', '15:20:07', 'Solicitud de información de tecnologia', 'Interno', 'Memorandúm', 'C.P MARIO ANTONIO REYES BAUTISTA', 'DIRECTOR ADMINISTRATIVO', 'CSEIIO', 4, '2017-10-06', 'oficioaplaneacionpdf.pdf', 'Contestado', 'Alta', 'Ninguna', 1, 1, 1, 1),
(6, 'CSEIIO/DP/1234/2017', '2017-10-04', '12:35:07', 'Solicitud de información', 'Interno', 'Memorandúm', 'LIC. JACOBO SÁNCHEZ LÓPEZ', 'DIRECTOR DE PLANEACIÓN', 'CSEIIO', 5, '2017-10-06', 'estadosdecuentapdf.pdf', 'Pendiente', 'Alta', 'Ninguna', 1, 0, 1, 0),
(7, 'CSEIIO/BS/1234/2017', '2017-10-04', '16:45:11', 'Solicitud de información', 'Interno', 'Memorandúm', 'LIC. SALVADOR AVENDAÑO HERNÁNDEZ', 'JEFE DE DEPARTAMENTO', 'CSEIIO', 4, '2017-10-06', 'bienesoficiopdf.pdf', 'Fuera de Tiempo', 'Alta', 'Ninguna', 1, 0, 1, 1),
(8, 'CSEIIO/BS/1254/2017', '2017-10-04', '16:59:39', 'Solicitud de información de tecnologia', 'Interno', 'Memorandúm', 'LIC. SALVADOR AVENDAÑO HERNÁNDEZ', 'JEFE DE DEPARTAMENTO', 'CSEIIO', 4, '2017-10-06', 'bienesoficiopdf.pdf', 'Pendiente', 'Alta', 'Ninguna', 1, 0, 1, 0),
(9, 'CSEIIO/DP/567/2017', '2017-10-31', '15:57:19', 'Solicitud de información de algo', 'Interno', 'Memorandúm', 'LIC. JACOBO SÁNCHEZ LÓPEZ', 'DIRECTOR DE PLANEACIÓN', 'CSEIIO', 2, '2017-11-03', 'formatolicjacobopdf.pdf', 'Pendiente', 'Alta', 'Ninguna', 1, 0, 1, 0),
(10, 'CSEIIO/DTYC/567/2017', '2017-10-31', '18:05:35', 'Solicitud de informacion', 'Interno', 'Memorandúm', 'ING. ROMEO CANSINO LÓPEZ', 'JEFE DE DEPARTAMENTO', 'CSEIIO', 2, '2017-11-03', 'formatolicjacobopdf.pdf', 'Pendiente', 'Alta', 'Turnar a bienes', 1, 0, 1, 0);
...
INSERT INTO `empleados` (`clave_area`, `nombre_empleado`, `direccion`, `departamento`, `descripcion`, `email`, `isDir`) VALUES
('academico_academias', 'LIC. DALILA CARBALLIDO GARCÍA', 7, 22, 'JEFA DE DEPARTAMENTO', NULL, NULL),
('academico_curricular', 'DEPARTAMENTO DE DISEÑO CURRICULAR', 7, 32, 'JEFE DE DEPARTAMENTO', NULL, NULL),
('academico_evaluacion', 'DEPARTAMENTO DE SEGUIMIENTO Y EVALUACIÓN', 7, 18, 'JEFE DE DEPARTAMENTO', NULL, NULL),
('academico_extension', 'LIC. MIREYA AQUINO DIEGO', 7, 17, 'JEFA DE DEPARTAMENTO', NULL, NULL),
('academico_recepcion', 'CLARA ELENA CABALLERO LOPEZ', 7, 31, 'RECEPCIÓN ACADÉMICA', NULL, NULL),
('academico_subdireccion', 'LIC. DORA PATRICIA LUNA TORRES', 7, 7, 'JEFA DE DEPARTAMENTO', NULL, NULL),
('academico_vinculacion', 'ING.JULIÁN EDUARDO HERNÁNDEZ RUIZ', 7, 16, 'JEFE DE DEPARTAMENTO', NULL, NULL),
('acervo', 'LIC. BEATRIZ DOMINGUEZ AGUILAR', 6, 34, 'UNIDAD DE ACERVO', NULL, 1),
('admin_bienes', 'LIC. SALVADOR AVENDAÑO HERNÁNDEZ', 2, 10, 'JEFE DE DEPARTAMENTO', NULL, NULL),
('admin_contabilidad', 'C.P LUIS ANTONIO SANTOS LÓPEZ', 2, 9, 'JEFE DE DEPARTAMENTO', NULL, NULL),
('admin_financieros', 'LIC. ARACELI COLÍN JIMENEZ', 2, 11, 'JEFA DE DEPARTAMENTO', NULL, NULL),
('admin_rh', 'LIC. JENNY JASMÍN LÓPEZ ANTONIO', 2, 8, 'JEFA DE DEPARTAMENTO', NULL, NULL),
('dir_academico', 'LIC. JORGE GIL LÓPEZ ESTEVA', 7, NULL, 'DIRECTOR ACADÉMICO', NULL, 1),
('dir_admin', 'C.P MARIO ANTONIO REYES BAUTISTA', 2, NULL, 'DIRECTOR ADMINISTRATIVO', NULL, 1),
('dir_general', 'PROFA. EMILIA GARCÍA GUZMÁN', 1, NULL, 'DIRECTORA GENERAL', NULL, 1),
('dir_planeacion', 'LIC. JACOBO SÁNCHEZ LÓPEZ', 4, NULL, 'DIRECTOR DE PLANEACIÓN', 'j.alejandrochimal92@gmail.com', 1),
('dir_uesa', 'ARQ. DAVID RUIZ NIVÓN', 3, NULL, 'DIRECTOR DE LA UESA', NULL, 1),
('plan_cescolar', 'LIC. AMADA CRUZ NIETO', 4, 12, 'JEFA DE DEPARTAMENTO', 'control.escolar@ejemplo.com', NULL),
('plan_estadistica', 'ING. DAVID ERNESTO HERNÁNDEZ AVENDAÑO', 4, 14, 'JEFE DE DEPARTAMENTO', 'desarrollador2@cseiio.edu.mx', NULL),
('plan_infra', 'ING. EUGENIO GALINDO TORRES', 4, 15, 'JEFE DE DEPARTAMENTO', 'desarrollador2@cseiio.edu.mx', NULL),
('plan_tecnologia', 'ING. ROMEO CANSINO LÓPEZ', 4, 13, 'JEFE DE DEPARTAMENTO', 'j.alejandrochimal92@gmail.com', NULL),
('recepcion_dir', 'RECEPCIONISTA DE DIRECCIÓN GENERAL', 1, 33, 'RECEPCIÓN DE DIRECCIÓN GENERAL', NULL, NULL),
('recepcion_oficialia', 'UNIDAD CENTRAL DE CORRESPONDENCIA', 1, 23, 'Unidad Central de Correspondencia', 'desarrolladorcseiio2@gmail.com', NULL),
('sysadmin', 'SYSTEM WEBADMIN ', 4, 13, 'ADMINISTRADOR', NULL, NULL),
('uesa_academico', 'DEPARTAMENTO ACADÉMICO DE LA UESA', 3, 20, 'JEFE DE DEPARTAMENTO', 'uesa.academico@ejemplo.com', NULL),
('uesa_proyectos', 'DEPARTAMENTO DE PROYECTOS ESPECIALES DE LA UESA', 3, 19, 'JEFE DE DEPARTAMENTO', NULL, NULL),
('uesa_publicaciones', 'LIC. OSCAR SANTIAGO SERRANO HERRERA', 3, 21, 'JEFE DE DEPARTAMENTO', NULL, NULL),
('unidad_juridica', 'LIC. PAVEL ALDRETE GARCÍA', 5, 34, 'JEFE DE UNIDAD JURIDICA', NULL, 1);
...
(2, 'CSEIIO/D.G/1235/2017', '2017-10-30', '15:26:29', 'Solicitud de informacion de becas', 'Externo', 'Oficio', 'Direccion General', 'Profra. Emilia García Guzman', 'Direccion General', 'ING. DAVID HERNANDEZ AVENDAÑO', 'JEFE DEL DEPTO DE ESTADISTCA', 'Lic. Juan Pedro Ruiz', 'Secretario de PROSPERA OAXACA', 'PROSPERA', 'croquisReducidopdf.pdf', 'Ninguna', 48);
...
(37, 'SEP/DG/DP/1009/2017', '2017-09-28', '09:41:35', 'Solicitud de apoyo', 'Externo', 'Oficio', 'Lic. Maria Eugenia Comenares Robles', 'SEP', 'Coordinadora de Servicios Académicos de la SEP', 7, '2017-09-29', 'oficioexamplepdf.pdf', 'No Contestado', 'Alta', 'Ninguna', 1, 0, 1, 0, 0),
(38, 'OFICIO UNAM/1567/2017', '2017-09-28', '09:43:10', 'Solicitud de matricula de la UESA', 'Externo', 'Oficio', 'Ing. Raul Maximino Santos', 'UNAM Ingenieria ', 'Rector de la Unidad de Ingeneria de la UNAM', 3, '2017-09-29', 'uesapdf.pdf', 'No Contestado', 'Alta', 'Ninguna', 1, 0, 1, 0, 0),
(39, 'DEMS-2017-1358', '2017-10-02', '10:12:38', 'Cuarto Concurso Nacional de Fotografía ', 'Externo', 'Oficio', 'M.A Isaías Jiménez Díaz', 'CGEMSyCyT', 'Director de Educación Media Superior', 4, '2017-10-06', '03CSEIIOpdf.pdf', 'Contestado', 'Alta', 'Turnar al departamento correspondiente', 1, 0, 1, 1, 0),
(40, 'SEP/123/RG/234/UJ', '2017-10-10', '12:40:42', 'Solicitud de informacion', 'Externo', 'Oficio', 'Lic. Alberto Salgado Robles', 'SEP', 'Coordinador de Educacion superior SEP', 4, '2017-10-13', 'oficio1pdf.pdf', 'Contestado', 'Alta', 'Ninguna', 1, 0, 0, 1, 0),
(41, 'SEP/123/RG/234/345', '2017-10-10', '12:43:03', 'Solicitud de informacion', 'Externo', 'Oficio', 'Lic. Alberto Salgado Robles', 'SEP', 'Coordinador de Educacion superior SEP', 4, '2017-10-11', 'oficio2pdf.pdf', 'Fuera de Tiempo', 'Alta', 'Ninguna', 1, 0, 1, 1, 0),
(42, 'SEP/123/RG/234/389', '2017-10-12', '13:45:35', 'Solicitud de informacion', 'Externo', 'Oficio', 'Lic. Alberto Salgado Robles', 'SEP', 'Coordinador de Educacion superior SEP', 4, '2017-10-17', 'academicopdf.pdf', 'Contestado', 'Alta', 'Ninguna', 1, 0, 0, 1, 0),
(43, 'SEP/123/RG/234/378', '2017-10-12', '13:51:37', 'Solicitud de informacion', 'Externo', 'Oficio', 'Lic. Alberto Ortiz Cabrera', 'SEP', 'Coordinador de Educacion superior SEP', 4, '2017-10-14', 'academicopdf.pdf', 'Fuera de Tiempo', 'Alta', 'Ninguna', 1, 0, 0, 1, 0),
(44, 'SEP/123/RG/234/390', '2017-10-12', '14:04:05', 'Solicitud de informacion', 'Externo', 'Oficio', 'Lic. Alberto Salgado Robles', 'SEP', 'Coordinador de Educacion superior SEP', 4, '2017-10-18', 'inepdf.pdf', 'Contestado', 'Alta', 'Ninguna', 1, 0, 1, 1, 0),
(45, 'SEP/123/RG/234/456', '2017-10-12', '14:31:33', 'Solicitud de informacion', 'Externo', 'Oficio', 'Lic. Alberto Ortiz Cabrera', 'SEP', 'Coordinador de Educacion superior SEP', 4, '2017-10-19', 'semsplaneacionpdf.pdf', 'Contestado', 'Alta', 'Ninguna', 1, 0, 1, 1, 0),
(46, 'SEP/123/RG/234/378', '2017-10-12', '14:38:15', 'Solicitud de informacion', 'Externo', 'Oficio', 'Lic. Alberto Salgado Robles', 'SEP', 'Coordinador de Educacion superior SEP', 4, '2017-10-19', 'guiapersonalizaturedTG788vnpdf.pdf', 'Contestado', 'Alta', 'Ninguna', 1, 0, 1, 1, 0),
(47, 'SEP/123/RG/234/389', '2017-10-12', '16:18:16', 'Solicitud de informacion', 'Externo', 'Oficio', 'Lic. Alberto Salgado Robles', 'SEP', 'Coordinador de Educacion superior SEP', 1, '2017-10-14', 'inepdf.pdf', 'No Contestado', 'Alta', 'Ninguna', 1, 0, 1, 0, 0),
(48, 'SEP/123/RG/234/378', '2017-10-12', '16:24:26', 'Solicitud de informacion', 'Externo', 'Oficio', 'Lic. Alberto Salgado Robles', 'SEP', 'Coordinador de Educacion superior SEP', 7, '2017-10-13', 'inventariotecnologiapdf.pdf', 'No Contestado', 'Alta', 'Ninguna', 1, 1, 0, 0, 0),
(49, 'SEP/123/RG/234/378', '2017-10-12', '16:25:10', 'Solicitud de informacion', 'Externo', 'Oficio', 'Lic. Alberto Salgado Robles', 'SEP', 'Coordinador de Educacion superior SEP', 4, '2017-10-19', 'oficioapoyoestadisticapdf.pdf', 'Contestado', 'Alta', 'Ninguna', 1, 1, 1, 1, 0),
(50, 'SEP/123/RG/234/389', '2017-10-12', '16:26:38', 'Solicitud de informacion', 'Externo', 'Oficio', 'Lic. Alberto Salgado Robles', 'SEP', 'Coordinador de Educacion superior SEP', 4, '2017-10-18', 'inepdf.pdf', 'Contestado', 'Alta', 'Ninguna', 1, 0, 1, 1, 0),
(51, 'SEP/123/RG/234/UJ', '2017-10-12', '16:28:34', 'Solicitud de informacion', 'Externo', 'Oficio', 'Lic. Alberto Salgado Robles', 'SEP', 'Coordinador de Educacion superior SEP', 4, '2017-10-19', 'oficiodesolicituddecableUTPParaexteriorespdf.pdf', 'Contestado', 'Alta', 'Ninguna', 1, 1, 1, 1, 0),
(52, 'SEP/123/RG/234/3889', '2017-10-12', '16:58:51', 'Solicitud de informacion', 'Externo', 'Oficio', 'Lic. Alberto Ortiz Cabrera', 'SEP', 'Coordinador de Educacion superior SEP', 4, '2017-10-20', 'estadisticapdf.pdf', 'Fuera de Tiempo', 'Alta', 'Ninguna', 1, 0, 1, 1, 0),
(53, 'SEP/123/RG/234/391', '2017-10-23', '17:26:21', 'Solicitud de informacion', 'Externo', 'Oficio', 'Lic. Alberto Salgado Robles', 'SEP', 'Coordinador de Educacion superior SEP', 4, '2017-10-27', 'academicopdf.pdf', 'Contestado', 'Alta', 'Ninguna', 1, 0, 1, 1, 0),
(54, 'SEP/123/RG/294/378', '2017-10-23', '17:41:23', 'Solicitud de informacion', 'Externo', 'Oficio', 'Lic. Alberto Ortiz Cabrera', 'SEP', 'Coordinador de Educacion superior SEP', 4, '2017-10-27', 'inepdf.pdf', 'Contestado', 'Alta', 'Ninguna', 1, 1, 1, 1, 0),
(55, 'INE/DEPURACION/9908/2017', '2017-10-24', '11:49:26', 'Solicitud de apoderado legal', 'Externo', 'Oficio', 'Lic. Anuard Martínez Vázquez', 'Instituto Nacional Electoral', 'Jefe del Departamento de Depuración del INE', 5, '2017-10-27', 'UJpdf.pdf', 'Contestado', 'Alta', 'Ninguna', 1, 0, 1, 1, 0),
(56, 'IEBO/PLANEACION/TEC/123/2017', '2017-10-30', '11:39:24', 'Solicitud de informacion', 'Externo', 'Oficio', 'Lic. Gabriel Santos Diaz', 'IEBO', 'Director de Planeaciòn del IEBO', 4, '2017-11-03', 'croquisReducidopdf.pdf', 'Contestado', 'Alta', 'Ninguna', 1, 1, 1, 1, 0),
(57, 'IEBO/PLANEACION/TEC/124/2017', '2017-10-30', '14:09:45', 'Solicitud de informacion', 'Externo', 'Oficio', 'Lic. Gabriel Santos Diaz', 'IEBO', 'Director General del IEBO', 4, '2017-11-03', 'formatoregistroTICSpdf.pdf', 'No Contestado', 'Alta', 'Ninguna', 1, 0, 1, 0, 0),
(58, 'ACD/1267/2017', '2017-10-31', '14:21:05', 'Solicitud de informacion', 'Externo', 'Oficio', 'Lic. Alberto Salgado Robles', 'SEP', 'Coordinador de Educacion superior SEP', 4, '2017-11-03', 'formatolicjacobopdf.pdf', 'No Contestado', 'Alta', 'Realizar la respuesta lo mas pronto posible\r\n       ', 1, 1, 1, 0, 0),
(59, 'SEMS/DG/0456/2017', '2017-11-08', '10:40:28', 'Solicitud de información ', 'Externo', 'Oficio', 'Lic. Anuard Martínez Vázquez', 'Subsecretaria de Educación Media Superior', 'Director General de la SEMS', 7, '2017-11-17', 'ejemplopdf.pdf', 'Pendiente', 'Alta', 'Ninguna', 1, 0, 1, 0, 0),
(60, 'SEMS/DG/0457/2017', '2017-11-08', '12:46:12', 'Solicitud de informacion', 'Externo', 'Oficio', 'Lic. Alberto Salgado Robles', 'Subsecretaria de Educación Media Superior', 'Director General de la SEMS', 4, '2017-11-13', 'ejemplo2pdf.pdf', 'Pendiente', 'Alta', 'Realizar la contestación lo mas pronto posible', 1, 1, 1, 0, 0);
...
--
ALTER TABLE `asignacion_interna`
  MODIFY `id_asignacion_int` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
--
...
--
ALTER TABLE `emision_interna`
  MODIFY `id_recepcion_int` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;
--
-- AUTO_INCREMENT de la tabla `oficios_salida`
--
ALTER TABLE `oficios_salida`
  MODIFY `id_oficio_salida` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
--
-- AUTO_INCREMENT de la tabla `recepcion_oficios`
--
ALTER TABLE `recepcion_oficios`
  MODIFY `id_recepcion` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=61;
--
-- AUTO_INCREMENT de la tabla `respuesta_interna`
--
ALTER TABLE `respuesta_interna`
  MODIFY `id_respuesta_int` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
--
-- AUTO_INCREMENT de la tabla `respuesta_oficios`
--
ALTER TABLE `respuesta_oficios`
  MODIFY `id_respuesta` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=20;
--
