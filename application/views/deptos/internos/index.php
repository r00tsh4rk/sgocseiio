    ...
    <div id="wrapper">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">
                            Departamentos <small>Buzón de Oficios Internos</small>
                        </h1>
                        <ol class="breadcrumb">
                            <li class="active">
        ...
        <hr>
        <div  class="row">
            <div id="buzon_interno" class="table-responsive">
...
<div class="modal fade" id="modal" tabindex="-1" role="dialog" aria-hidden="true">
  <div class="modal-dialog">
    ...
    <form data-toggle="validator" enctype="multipart/form-data" role="form" method="POST" name="frmRespuesta" action="<?php echo base_url(); ?>Departamentos/Interno/BuzonInterno/agregarRespuestaDepto">
        <div class="col-lg-12">
          <br>
