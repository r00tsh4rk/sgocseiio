                ...
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">
                            <?php echo $this->session->userdata('nombre_direccion'); ?> <small>Oficios Pendientes de Responder por otras Direcciones</small>
                        </h1>
                        <ol class="breadcrumb">
                            <li class="active">
                    ...
                    <thead style="background-color:#50C1C1; color:#FFFFFF; font-size: smaller; text-aling:center;">
                        ...
                        <tbody style="font-size:smaller; font-weight: bold ;">
                               ...
                               <tr>
                                    ...
                                    <td>
                                        <a href="<?php echo base_url()?>Direcciones/Interno/PendientesInternos/Descargar/<?php echo $row->archivo_oficio; ?>">
