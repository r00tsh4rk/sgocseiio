                ...
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">
                            <?php echo $this->session->userdata('nombre_direccion'); ?> <small>Oficios Contestados</small>
                        </h1>
                        <ol class="breadcrumb">
                            <li class="active">
                    ...
                    <thead style="background-color:#8A8F8F; color:#FFFFFF; font-size: smaller; text-aling:center;">
                        ...
                        <tbody style="font-size:smaller; font-weight: bold ;">
                               ...
                               <tr>
                                    ...
                                    <td>
                                        <a href="<?php echo base_url()?>Direcciones/Externos/ContestadosDir/Descargar/<?php echo $row->archivo_oficio; ?>">
                                    ...
                                    <td>
                                        <a href="<?php echo base_url()?>Direcciones/Externos/ContestadosDir/DescargarRespuesta/<?php echo $row->acuse_respuesta; ?>">
                                      ...
                                      <!-- ANEXOS -->
                                     <td>
                                        <a href="<?php echo base_url()?>Direcciones/Externos/ContestadosDir/DescargarAnexos/<?php echo $row->anexos; ?>">
