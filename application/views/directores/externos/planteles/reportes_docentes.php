      ...
      <div id="page-wrapper">
        ...
        <div class="container-fluid">
          ...
          <ul class="nav nav-tabs">
            ...
            <li><a data-toggle="tab" href="#menu1">Reportes de Oficios de Docentes</a></li>
          </ul>
          ...
          <div id="menu1" class="tab-pane fade">
            ...
            <div class="tab-content">
              <div id="inicioGeneral" class="tab-pane fade in active">
                <h3>Panel de Reportes de Oficios Capturados</h3>
                <p>Bienvenido al Panel de Reportes por Plantel del Sistema de Oficios del CSEIIO</p>
              </div>

              <div id="generales1" class="tab-pane fade">
                <h3>Total de Oficios Capturados</h3>
                <br>
                <h4>Genera el total de oficios capturados provenientes de los docentes del: <?php echo $this->session->userdata('nombre_direccion'); ?> </h4>

                <br>

                <form class="form-horizontal" role="form" method="POST" action="<?php echo base_url(); ?>Direcciones/Externos/Planteles/Reportes_docentes/reporteAllCapturadosDocentes">
              ...
              <div id="generales2" class="tab-pane fade">
                ...
                <form class="form-horizontal" role="form" method="POST" action="<?php echo base_url(); ?>Direcciones/Externos/Planteles/Reportes_docentes/informativos">
              ...
              <div id="generales3" class="tab-pane fade">
               ...
               <br>
               <h4>Genera el reporte de los oficios contestados, emitidos por los docentes.</h4>

               <br>

               <form class="form-horizontal" role="form" method="POST" action="<?php echo base_url(); ?>Direcciones/Externos/Planteles/Reportes_docentes/reporteContestados">
                <p style="color: #EF4444; font-weight: bold;">*Seleccione el periodo de fechas en el que desee conocer el total de oficios contestados, emitidos por los docentes.</p>
                <div class="form-group">
                  <label for="fecha_inicio" class="col-lg-2 control-label">Fecha de Inicio:</label>
                  <div class="col-lg-6">
                    <input type="date" class="form-control" id="date_inicio" name="date_inicio"  value="<?php echo date('Y-m-d') ?>"/>
