        ...
        <div class="col-lg-12">
          ...
          <div class="form-group has-feedback">
            ...
            <div class="input-group">
                ...
                <input name="num_oficio" id="noficio" class="form-control" placeholder="Ej. BIC12/078/2017" required>
            </div>  
...
function EditarOficio(id,num_oficio, asunto, tipo_emision,  tipo_documento, remitente,cargo_remitente, dependencia_remitente, observaciones, emisor, bachillerato_emisor, cargo_emisor)
{
