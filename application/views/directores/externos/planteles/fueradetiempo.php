    ...
    for ($midia = $fechainicio; $midia <= $fechafin; $midia += $diainc) {
        ...
        <div id="wrapper">
            ...
            <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
                ...
                <ul class="nav navbar-nav side-nav">
                    ...
                    <li>
                        <a href="<?php echo base_url(); ?>Direcciones/Externos/Planteles/Contestados"><i class="fa fa-check-circle"></i> Contestados</a>
                    </li>

                    <li class="active">
                        <a href="<?php echo base_url(); ?>Direcciones/Externos/Planteles/ContestadosFueraTiempo"><i class="fa fa-bell-slash"></i> Contestados Fuera de Tiempo</a>
                    </li>
        ...
        <div id="page-wrapper">
            ...
            <div class="container-fluid">
                      ...
                      <tbody style="font-size:smaller; font-weight: bold ;">
                        <?php foreach ($fueratiempo as $row) { 
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="<?php echo base_url()?>RecepcionGral/Salidas/ContestadosFueraTiempo/Descargar/<?php echo $row->archivo_oficio; ?>">
                ...
                <td>
                  <a href="<?php echo base_url()?>RecepcionGral/Salidas/ContestadosFueraTiempo/DescargarRespuesta/<?php echo $row->acuse_respuesta; ?>">
             ...
             <!-- ANEXOS -->
             <td>
                <a href="<?php echo base_url()?>RecepcionGral/Salidas/ContestadosFueraTiempo/DescargarAnexos/<?php echo $row->anexos; ?>">
