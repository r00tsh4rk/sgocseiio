        ...
        <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
            ...
            <!-- Sidebar Menu Items - These collapse to the responsive navigation menu on small screens -->
                ...
                <ul class="nav navbar-nav side-nav">
                    ...
                    <li>
                        <a href="<?php echo base_url(); ?>Direcciones/Externos/RecepcionDir"><i class="fa fa-exchange"></i> Oficios Externos</a>
                    </li>
                    <li>
                        <a href="<?php echo base_url(); ?>Direcciones/Interno/BuzonInterno"><i class="fa fa-university"></i> Oficios Internos</a>
                    </li>
                </ul>
            </div>
            <!-- /.navbar-collapse -->
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">
                            <?php echo $this->session->userdata('nombre_direccion'); ?> <small>Sistema de Gestión de Oficio del CSEIIO</small>
                        </h1>
                        <ol class="breadcrumb">
                            <li class="active">
                ...
                <div class="row">
                            ...
                            <div class="panel-heading">
                                <div class="row">
                                    ...
                                    <div class="col-xs-9 text-right">
                                        <div class="huge"><?php echo $pendientesext+$nocontestadosext; ?></div>
                                        <div>Pendientes</div>
                                    </div>
                                </div>
                            </div>
                            <a href="<?php echo base_url(); ?>Direcciones/Externos/PendientesDir">
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="panel panel-red">
                            ...
                            <a href="<?php echo base_url(); ?>Direcciones/Externos/NoContestadosDir">
                                <div class="panel-footer">
                                    <span class="pull-left">Más Información</span>
                                    <span class="pull-right"><i class="fa fa-arrow-circle-right"></i></span>
                                    <div class="clearfix"></div>
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="panel panel-green">
                            ...
                            <a href="<?php echo base_url(); ?>Direcciones/Externos/ContestadosDir">
                                <div class="panel-footer">
                                    <span class="pull-left">Más Información</span>
                                    <span class="pull-right"><i class="fa fa-arrow-circle-right"></i></span>
                                    <div class="clearfix"></div>
                      ...
                      <div class="col-lg-3 col-md-6">
                        <div class="panel panel-orange">
                            ...
                            <a href="<?php echo base_url(); ?>Direcciones/Externos/ContestadosFueraTiempoDir">
                                <div class="panel-footer">
                                    <span class="pull-left">Más Información</span>
                                    <span class="pull-right"><i class="fa fa-arrow-circle-right"></i></span>
                                    <div class="clearfix"></div>
                        ...
                        <div class="panel panel-primary">
                            ...
                            <a href="<?php echo base_url(); ?>Direcciones/Externos/RecepcionDir">
                                <div class="panel-footer">
                        ...
                        <div class="panel panel-yellow">
                            <div class="panel-heading">
                                <div class="row">
                                    ...
                                    <div class="col-xs-9 text-right">
                                        <div class="huge"><?php echo $pendientesint; ?></div>
                                        <div>Pendientes</div>
                                    </div>
                                </div>
                            </div>
