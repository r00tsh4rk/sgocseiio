                    ...
                    <thead style="background-color:#8A8F8F; color:#FFFFFF; font-size: smaller; text-aling:center;">
                        ...
                        <tbody style="font-size:smaller; font-weight: bold ;">
                               ...
                               <tr>
                                    ...
                                    <td>
                                        <a href="<?php echo base_url()?>RecepcionGral/Pendientes/Descargar/<?php echo $row->archivo_oficio; ?>">
                                    ...
                                    <td><?php echo $row->cargo; ?></td>
                                          <td>
                                        <a href="<?php echo base_url()?>Direcciones/ContestadosDir/DescargarRespuesta/<?php echo $row->acuse_respuesta; ?>">
                                      ...
                                      <!-- ANEXOS -->
                                     <td>
                                        <a href="<?php echo base_url()?>Direcciones/ContestadosDir/DescargarAnexos/<?php echo $row->anexos; ?>">
