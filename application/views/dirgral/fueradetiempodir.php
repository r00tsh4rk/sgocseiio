                        ...
                        <tbody style="font-size:smaller; font-weight: bold ;">
                               ...
                               <tr>
                                    ...
                                    <td><?php echo $row->cargo; ?></td>
                                       <td>
                                        <a href="<?php echo base_url()?>RecepcionGral/Pendientes/Descargar/<?php echo $row->acuse_respuesta; ?>">
                                         <img src="<?php echo base_url(); ?>assets/img/respuesta.png" alt="Descargar">
                                    </a>
                                    </td>
                                     <!-- ANEXOS -->
                                     <td>
                                        <a href="<?php echo base_url()?>RecepcionGral/Pendientes/Descargar/<?php echo $row->anexos; ?>">
