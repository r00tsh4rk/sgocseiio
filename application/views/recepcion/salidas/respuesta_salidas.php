            ...
            <tbody style="font-size:smaller; font-weight: bold ;">
              <?php foreach ($res_salidas as $row) { 
                ...
                <tr>
                  ...
                  <td><?php echo 'Directora General' ?></td>
                  <td><?php echo $row->fecha_emision; ?></td>
                  <td><?php echo $row->hora_emision; ?></td>
                  <td>
                    <a href="<?php echo base_url()?>RecepcionGral/Salidas/Respuesta_salidas/Descargar/<?php echo $row->archivo; ?>">
               ...
               <td><?php echo $row->num_oficio_salida; ?></td>
                  ...
                  <td>
                    <a href="<?php echo base_url()?>RecepcionGral/Salidas/Respuesta_salidas/DescargarRespuesta/<?php echo $row->acuse_respuesta; ?>">
                 ...
                 <!-- ANEXOS -->
                 <td>
                  <a href="<?php echo base_url()?>RecepcionGral/Salidas/Respuesta_salidas/DescargarAnexos/<?php echo $row->anexos; ?>">
