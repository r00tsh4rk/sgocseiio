            ...
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">
                        <?php echo $this->session->userdata('descripcion'); ?>  <small>Oficios de Salida</small>
                    </h1>
                    <ol class="breadcrumb">
                        <li class="active">
...
<div class="modal fade" id="modal" tabindex="-1" role="dialog" aria-hidden="true">
  <div class="modal-dialog">
    ...
    <form data-toggle="validator" enctype="multipart/form-data" role="form" method="POST" name="frmRegistroOficio" action="<?php echo base_url(); ?>RecepcionGral/Salidas/PanelSalidas/agregarEntrada">
        <div class="col-lg-12">
          <br>
        ...
        <div class="form-group has-feedback">
            <label for="fun_emisor" class="control-label">Funcionario que realiza el oficio</label>
            <div class="input-group">
                <span class="input-group-addon"></span>
        ...
        <div class="form-group has-feedback">
            ...
            <div class="input-group">
                <span class="input-group-addon"></span>
                <input name="cargo" id="cargo" class="form-control" placeholder="Jefe del Depto de Estadística"  required>
            </div> 
            <span class="glyphicon form-control-feedback" aria-hidden="true"></span>
          <div class="help-block with-errors"></div>  
        </div>
...
<div class="modal fade" id="modalRespuestas" tabindex="-1" role="dialog" aria-hidden="true">
          <div class="modal-dialog">
            ...
            <form data-toggle="validator" enctype="multipart/form-data" role="form" method="POST" name="frmRespuesta" action="<?php echo base_url(); ?>RecepcionGral/Salidas/Respuesta_salidas/agregarRespuesta">
                <div class="col-lg-12">
                  <br>
...
<div class="modal fade" id="modalActualizar" tabindex="-1" role="dialog" aria-hidden="true">
  <div class="modal-dialog">
    ...
    <form enctype="multipart/form-data" role="form" method="POST" name="frmEditarOficio" action="<?php echo base_url(); ?>RecepcionGral/Salidas/PanelSalidas/ModificarOficio">
        <div class="col-lg-12">
          <br>
...
function EditarOficio(id,num_oficio, asunto, tipo_emision,  tipo_documento, fun_emisor, cargo, remitente,cargo_remitente, dependencia_remitente, observaciones)
{
